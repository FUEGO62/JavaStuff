...
public class TetrisDriver {
    public static void main(String[] args) {
	    ...
	    board =  TetrisBoard.setBlock(board,col,randomNum,map);
            board =  TetrisBoard.mergeTriangles(board,col,map);
            board =  TetrisBoard.clearLine(board,map);
	    board =  TetrisBoard.addGravityEffect(board);
            board =  TetrisBoard.mapBoard(board,map);
